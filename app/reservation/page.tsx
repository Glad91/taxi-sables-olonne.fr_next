...
export const metadata: Metadata = {
  ...
  description: "Réservez votre taxi aux Sables-d'Olonne en ligne. Formulaire de réservation simple et rapide. Service 24h/24. ☎️ 06 25 19 31 43",
  keywords: ["réservation taxi sables d'olonne", "réserver taxi en ligne", "booking taxi sables d'olonne"],
  alternates: {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div className="bg-white p-8 rounded-lg shadow-lg">
              ...
              <form className="space-y-6">
                ...
                <div>
                  <label htmlFor="depart" className="block text-sm font-medium text-gray-700 mb-2">
                    Adresse de départ *
                  </label>
                  <div className="relative">
                ...
                <div>
                  <label htmlFor="passagers" className="block text-sm font-medium text-gray-700 mb-2">
                    Nombre de passagers
                  </label>
                  <select
                    id="passagers"
              ...
              <p className="text-sm text-gray-500 mt-4">
                * Champs obligatoires. Votre réservation sera confirmée par téléphone dans les plus brefs délais.
              </p>
            </div>

            <div className="space-y-8">
              <div className="bg-gray-50 p-6 rounded-lg">
                <h3 className="text-xl font-semibold mb-4">Réservation immédiate</h3>
              ...
              <div className="bg-green-50 p-6 rounded-lg">
                ...
                <div className="space-y-2 text-green-800">
                  <p><strong>Gare SNCF :</strong> À partir de 8€</p>
                  <p><strong>Centre-ville :</strong> À partir de 6€</p>
                  <p><strong>Aéroport Nantes :</strong> À partir de 120€</p>
                  <p><strong>Transport médical :</strong> Prise en charge Sécurité Sociale</p>
                </div>
